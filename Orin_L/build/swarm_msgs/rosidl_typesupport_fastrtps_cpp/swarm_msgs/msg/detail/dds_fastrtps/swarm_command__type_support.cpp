...
#include "swarm_msgs/msg/detail/swarm_command__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = swarm_msgs::msg::SwarmCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const swarm_msgs::msg::SwarmCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<swarm_msgs::msg::SwarmCommand *>(
    untyped_ros_message);
...
{
  return &swarm_msgs::msg::typesupport_fastrtps_cpp::_SwarmCommand__handle;
}
