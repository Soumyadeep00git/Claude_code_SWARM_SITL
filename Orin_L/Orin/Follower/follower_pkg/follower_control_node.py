...
class FollowerControlNode(Node):
    def __init__(self):
        ...
        self._bench_test = self.get_parameter('bench_test').value
        ...
        self.get_logger().info(
            ...
            f"{' *** BENCH TEST MODE ***' if self._bench_test else ''}"
        )
    ...
    def _get_mission(self, leader_fresh: bool) -> Mission:
        ...
        if rc_mission is not None:
            ...
            elif rc_mission == Mission.FOLLOW and not self._is_airborne and not self._bench_test:
