...
#include "swarm_msgs/msg/detail/swarm_command__rosidl_typesupport_fastrtps_c.h"
...
using _SwarmCommand__ros_msg_type = swarm_msgs__msg__SwarmCommand;
...
static uint32_t _SwarmCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_swarm_msgs__msg__SwarmCommand(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = swarm_msgs__msg__SwarmCommand;
    is_plain =
      (
...
static size_t _SwarmCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_swarm_msgs__msg__SwarmCommand(
